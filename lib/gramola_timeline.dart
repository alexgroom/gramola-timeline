  ...
  void _fetchTimeline() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        fetchTimelineEntriesSuccessAction(timelineEntries);
      } else {
        fetchTimelineEntriesFailureAction('Error: ' + response.statusCode);
        _showSnackbar('Error retrieving timeline!');
      }
    } on Exception catch (e) {
      fetchTimelineEntriesFailureAction(e.toString());
